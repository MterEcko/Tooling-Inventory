Public Class logstencilform
    ...
    Private Sub ButtonFindLogStencil_Click(sender As Object, e As EventArgs) Handles ButtonFindLogStencil.Click
        ...
        Else
            ...
            DataGridView2.DataSource = bdconexion.FindLogStencilDataGridViewer(textBoxLogStencil.Text, DataGridStencil.StencilNameEdit)
        End If
    End Sub
    ...
    Private Sub logstencilform_Load(sender As Object, e As EventArgs) Handles MyBase.Load
